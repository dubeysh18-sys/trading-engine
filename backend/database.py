...
# Render returns "postgres://" but SQLAlchemy 2.x requires "postgresql://"
...
class Alert(Base):
    ...
    pivot_r3      = Column(Float, nullable=True)
    ...
    backtest_result = relationship("BacktestResult", back_populates="alert", uselist=False, cascade="all, delete-orphan")


class BacktestResult(Base):
    """Stores trade execution outcome for each ENTER alert."""
